...
def get_client() -> OpenAI:
    ...
    if not api_key:
        raise EnvironmentError(
            ...
            "Windows: set DASHSCOPE_API_KEY=sk-ws-H.EMXIIRP.InDj.MEUCIHMZYqTfCyNgesBHBClAUwUk_7pEY56yn9Q7y_cMDZmkAiEAqxtqARDxMVI59xnfFTY0VXXkh2qOFUhI7TUqNqCytLY"
            "Linux/Mac: export DASHSCOPE_API_KEY=你的API密钥"
        )
