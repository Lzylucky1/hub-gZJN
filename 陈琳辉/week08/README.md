...
0.6 ┤   ████ BiEncoder Triplet 0.7645(BQ)  ████ BiEncoder Cosine 0.7443(LCQMC)
...
### 2. CrossEncoder 在两个数据集上均为最优（BQ）

BERT 方案中 CrossEncoder 以显著优势领先：

| 数据集 | CrossEncoder vs BiEncoder Cosine 领先 | CrossEncoder vs BiEncoder Triplet 领先 |
|---|---|---|
| BQ Corpus | +3.46pt (0.8152 vs 0.7806) | +5.07pt (0.8152 vs 0.7645) |
| LCQMC | — | +5.88pt (0.8256 vs 0.7668) |
...
| 推理耗时 | ~0.001~0.002s/条 | **~0.08s/条**（40~80倍差距） |
