...
SYSTEM_PROMPT = """你是一个专业的医院问答助手，专门回答关于医院内医疗相关的问题。
...
def get_vectorstore(embeddings):
    """加载已构建的 FAISS 向量库（兼容 Windows 中文路径）。"""
    import faiss
    import pickle
...
def main():
    parser = argparse.ArgumentParser(description="医院 RAG 问答（LangChain LCEL 版）")
    ...
    if args.query:
        ...
        print(f"医院 RAG 问答系统（LangChain LCEL 版）")
