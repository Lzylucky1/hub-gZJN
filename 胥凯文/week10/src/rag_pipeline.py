...
def get_client() -> OpenAI:
    api_key = "sk-ws-H.EMEPHHH.ylS8.MEUCIQCKSsAUZhYb357EV908SRHaIqsca4wMY3Q5DaQYFACd4QIgXM4VJM89Ll0fIK0qeb92PfAm8qk7ix53bgo42IiilX0"
    if not api_key:
...
class RAGPipeline:
    ...
    def query(
        ...
        if top_score < SCORE_THRESHOLD and filter_meta is None:
            return {
                "answer": "根据用户手册未能找到与该问题相关的内容，建议直接咨询老师。",
...
def main():
    parser = argparse.ArgumentParser(description="MX6U用户 RAG 问答（原生版）")
